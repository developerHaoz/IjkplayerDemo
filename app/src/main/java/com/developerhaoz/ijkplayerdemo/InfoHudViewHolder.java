...
import com.developerhaoz.ijkplayerdemo.media.TableLayoutBinder;
...
public class InfoHudViewHolder {
    ...
    private static String formatedSpeed(long bytes, long elpased_milli) {
        if (elpased_milli <= 0) {
            return "0 B/s";
        }
        ...
        float bytes_per_sec = ((float) bytes) * 1000.f / elpased_milli;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MSG_UPDATE_HUD:
                    ...
                    long audioCacheBytes = mp.getAudioCachedBytes();
                    ...
                    setRowValue(R.string.a_cache, String.format(Locale.US, "%s, %s", formatedDurationMilli(audioCachedDuration), formatedSize(audioCacheBytes)));
